...
Để thuận tiện, hệ thống sẽ cho người dùng chọn trước các sản phẩm mình muốn chọn:
  \begin{figure}[H]
        ...
        \end{figure}
         ...
         \begin{figure}[H]  
        \hspace*{-1cm}     
            \includegraphics[scale=0.3]{Images/insertDon1.png}
        \end{figure}
        ...
        \end{figure}
            ...
            \begin{figure}[H]  
        \hspace*{-0.9cm}     
            \includegraphics[scale=0.37]{Images/insertPharmaSucc.png}
        \end{figure}
...
\hspace*{-0.75cm}   
% \centering
    \includegraphics[scale=0.3]{Images/batch_warehouse/a2 (2).png}
