...
const { fetchUsers,insertEmployee,
  ...
  showOrderStatus,
  showShipperInfo,
  getCustomerDetails,fetchProductList,signin,showVoucherInfo } = require('./services');
...
server.addService(databaseService.service, { GetUser: fetchUsers,InsertEmployee: insertEmployee,
  ...
  GetCustomerDetails: getCustomerDetails, GetProductList: fetchProductList,Signin:signin,ShowVoucherInfo:showVoucherInfo});
